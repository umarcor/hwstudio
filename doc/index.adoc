...
* https://github.com/tilk/digitaljs[tilk/digitaljs] is a teaching-focused digital circuit simulator written in JavaScript with a companion https://github.com/tilk/yosys2digitaljs[tilk/yosys2digitaljs] tool for converting output from Yosys.

* https://www.bespokesynth.com[bespokesynth] (https://github.com/awwbees/BespokeSynth/[awwbees/BespokeSynth]): is a software modular synthesizer, with a GUI very similar to GNURadio or Godot's VisualScript.
